 ...
 */
@Service
public class PageJsBuilder extends AbstractBuilder {
    ...
    public void build(TableConfig tableConfig, List<Map<String, Object>> propertyList) throws Exception {
        ...
        File file = buildPageFile(tableConfig.getPage(), tableConfig.getPage() + ".js");
        writeFile("page_js.ftl", params, file, tableConfig);
    }
}
